...
import { ArrowLeft, Clock, Navigation, MapPin, Users, Settings, Play, ArrowUp, ArrowRight, ArrowUpRight, ArrowUpLeft, Flag, Plus, Circle, Infinity, X, Search, Save } from 'lucide-react'
...
const RoutePlanningPanel = ({ route, routes, onSelectRoute, onStart, onCancel, onConvoy, onAddStop, onSave, userLocation }) => {
            ...
            >
                ...
                <div style={{ padding: '0 20px 0', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    {!isExpanded && (
                        <div style={{
                            padding: '10px 0',
                            paddingBottom: 90, /* Clear NavDock */
                            display: 'flex', gap: 10,
                            alignItems: 'center',
                        }}>
                    ...
                    <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 20, minHeight: 0 }} className="no-scrollbar">
                        ...
                        <div style={{ padding: '0 20px 0' }}>
                            <RouteDetailsSection route={route} compact />
                        </div>
                    </div>

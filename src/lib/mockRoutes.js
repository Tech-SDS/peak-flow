...
export const ROUTE_DATABASE = [
  ...
  },
  {
    ...
    "distanceFromUser": 0,
    "hearts": 450,
    "image": "https://images.unsplash.com/photo-1579482559591-62d29b0a793a?w=800",
    "surface": { "asphalt": 98, "concrete": 2, "gravel": 0, "cobblestone": 0 },
    "elevation": { "gain": 950, "max": 1200, "minGradient": -10, "maxGradient": 12 },
    "hazards": { "speedHumps": 0, "potholes": 1, "unpaved": 0 },
    "chassisThreats": ["Narrow sections"],
    "atmosphere": ["Mountain", "Historic"],
    "coordinates": { "start": { "lat": 41.5932, "lng": 1.8315 }, "end": { "lat": 41.5932, "lng": 1.8315 } },
    "path": [
      { "lat": 41.5932, "lng": 1.8315 }, { "lat": 41.6, "lng": 1.81 },
      { "lat": 41.62, "lng": 1.78 }, { "lat": 41.64, "lng": 1.82 },
      { "lat": 41.61, "lng": 1.85 }, { "lat": 41.5932, "lng": 1.8315 }
    ],
    "waypoints": [
      { "name": "Monestir de Montserrat", "type": "scenic", "distanceKm": 15 },
      { "name": "Sant Jeroni Viewpoint", "type": "scenic", "distanceKm": 35 }
    ],
    "gallery": ["https://images.unsplash.com/photo-1579482559591-62d29b0a793a?w=400"]
  },
  {
    "id": "bcn-2",
    "name": "Costa Brava Scenic Drive",
    "region": "Costa Brava",
    "author": "Maria G.",
    "authorVerified": true,
    "theme": "Relaxed",
    ...
    "distanceFromUser": 0,
    "hearts": 612,
    "image": "https://images.unsplash.com/photo-1596485890919-ffcb99a4c58b?w=800",
    "surface": { "asphalt": 100, "concrete": 0, "gravel": 0, "cobblestone": 0 },
    "elevation": { "gain": 450, "max": 200, "minGradient": -5, "maxGradient": 6 },
    "hazards": { "speedHumps": 2, "potholes": 0, "unpaved": 0 },
    "chassisThreats": ["Tourist traffic"],
    "atmosphere": ["Coastal", "Cliffs"],
    "coordinates": { "start": { "lat": 41.7208, "lng": 2.9292 }, "end": { "lat": 41.85, "lng": 3.12 } },
    "path": [
      { "lat": 41.7208, "lng": 2.9292 }, { "lat": 41.75, "lng": 2.98 },
      { "lat": 41.78, "lng": 3.03 }, { "lat": 41.82, "lng": 3.08 },
      { "lat": 41.85, "lng": 3.12 }
    ],
    "waypoints": [
      { "name": "Tossa de Mar", "type": "scenic", "distanceKm": 25 },
      { "name": "Sant Feliu de Guíxols", "type": "rest", "distanceKm": 50 }
    ],
    "gallery": ["https://images.unsplash.com/photo-1596485890919-ffcb99a4c58b?w=400"]
  },
  {
    "id": "bcn-3",
    ...
    "distanceFromUser": 0,
    "hearts": 320,
    "image": "https://images.unsplash.com/photo-1563200782-b4ea22db4e81?w=800",
    "surface": { "asphalt": 95, "concrete": 0, "gravel": 5, "cobblestone": 0 },
    "elevation": { "gain": 1400, "max": 1600, "minGradient": -12, "maxGradient": 15 },
    "hazards": { "speedHumps": 0, "potholes": 2, "unpaved": 1 },
    "chassisThreats": ["Hairpin turns", "Fallen leaves"],
    "atmosphere": ["Forest", "Mountain"],
    "coordinates": { "start": { "lat": 41.768, "lng": 2.399 }, "end": { "lat": 41.768, "lng": 2.399 } },
    "path": [
      { "lat": 41.768, "lng": 2.399 }, { "lat": 41.78, "lng": 2.42 },
      { "lat": 41.8, "lng": 2.38 }, { "lat": 41.75, "lng": 2.35 },
      { "lat": 41.768, "lng": 2.399 }
    ],
    "waypoints": [
      { "name": "Turó de l'Home", "type": "scenic", "distanceKm": 40 },
      { "name": "Santa Fe Reservoir", "type": "scenic", "distanceKm": 65 }
    ],
    "gallery": ["https://images.unsplash.com/photo-1563200782-b4ea22db4e81?w=400"]
  },
  {
    "id": "bcn-4",
    "name": "Garraf Coast & Hills",
    "region": "Garraf",
    "author": "Carlos R.",
    "authorVerified": true,
    "theme": "Balanced",
    ...
    "distanceFromUser": 0,
    "hearts": 285,
    "image": "https://images.unsplash.com/photo-1533675080645-5645511b033d?w=800",
    "surface": { "asphalt": 96, "concrete": 4, "gravel": 0, "cobblestone": 0 },
    "elevation": { "gain": 600, "max": 450, "minGradient": -9, "maxGradient": 11 },
    "hazards": { "speedHumps": 1, "potholes": 0, "unpaved": 0 },
    "chassisThreats": ["Cyclists", "Rockfalls"],
    "atmosphere": ["Coastal", "Arid Hills"],
    "coordinates": { "start": { "lat": 41.258, "lng": 1.932 }, "end": { "lat": 41.258, "lng": 1.932 } },
    "path": [
      { "lat": 41.258, "lng": 1.932 }, { "lat": 41.27, "lng": 1.91 },
      { "lat": 41.3, "lng": 1.95 }, { "lat": 41.28, "lng": 1.98 },
      { "lat": 41.258, "lng": 1.932 }
    ],
    "waypoints": [
      { "name": "Garraf Cliffs", "type": "scenic", "distanceKm": 15 },
      { "name": "Sitges Overlook", "type": "scenic", "distanceKm": 30 }
    ],
    "gallery": ["https://images.unsplash.com/photo-1533675080645-5645511b033d?w=400"]
  },
  {
    "id": "bcn-5",
    "name": "Pre-Pyrenees Escape",
    "region": "Pre-Pyrenees",
    "author": "Peak Flow Curated",
    "authorVerified": true,
    "theme": "Spirited",
    ...
    "surface": { "asphalt": 90, "concrete": 5, "gravel": 5, "cobblestone": 0 },
    "elevation": { "gain": 2200, "max": 2100, "minGradient": -14, "maxGradient": 14 },
    "hazards": { "speedHumps": 0, "potholes": 3, "unpaved": 2 },
    "chassisThreats": ["Cattle grids", "Uneven surface"],
    "atmosphere": ["Alpine", "Remote"],
    "coordinates": { "start": { "lat": 42.146, "lng": 1.838 }, "end": { "lat": 42.3, "lng": 1.5 } },
    "path": [
      { "lat": 42.146, "lng": 1.838 }, { "lat": 42.18, "lng": 1.75 },
      { "lat": 42.22, "lng": 1.65 }, { "lat": 42.26, "lng": 1.58 },
      { "lat": 42.3, "lng": 1.5 }
    ],
    "waypoints": [
      { "name": "Berga Ascent", "type": "technical", "distanceKm": 45 },
      { "name": "Pedraforca Viewpoint", "type": "scenic", "distanceKm": 95 }
    ],
    "gallery": ["https://images.unsplash.com/photo-1506501139174-099022df5260?w=400"]
  }
];
